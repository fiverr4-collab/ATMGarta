...
export default function VehicleCard({ vehicle, onFavorite, isFavorite }: VehicleCardProps) {
  const navigate = useNavigate();

  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow cursor-pointer">
      <div className="relative" onClick={() => navigate(`/vehicles/${vehicle.id}`)}>
        <img
      ...
      <div className="p-4" onClick={() => navigate(`/vehicles/${vehicle.id}`)}>
